...
import { ArrowLeft, Clock, MapPin, Zap, Activity, ExternalLink, Waves } from 'lucide-react';
...
export async function generateMetadata({ 
  ...
  const title = `M${earthquake.magnitude.toFixed(1)} Earthquake - ${earthquake.place}`;
  const description = `${getMagnitudeLabel(earthquake.magnitude)} earthquake (M${earthquake.magnitude.toFixed(1)}) at ${earthquake.depth.toFixed(1)}km depth near ${earthquake.place}`;
