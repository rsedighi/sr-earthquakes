/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: efe2c19d0251a83c08114f2fb213906b)
// Runtime types generated with workerd@1.20260601.1 2026-05-28 nodejs_compat
interface __BaseEnv_Env {
	EARTHQUAKE_KV: KVNamespace;
	FEATURE_FLAGS_KV: KVNamespace;
	DB: D1Database;
	ASSETS: Fetcher;
	EARTHQUAKE_ROOM: DurableObjectNamespace /* EarthquakeRoom */;
	COMMENT_ROOM: DurableObjectNamespace /* CommentRoom */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/_worker");
		durableNamespaces: "EarthquakeRoom" | "CommentRoom";
	}
